...
public class SMActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smactivity);
        initView();
        ...
        Button btn1 = findViewById(R.id.save2);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ISM= new Intent();
                Bundle bundle = new Bundle();
                bundle.putCharSequence("name", buffer);
                bundle.putInt("total",total);
                ISM.putExtra("bundle",bundle);
                setResult(RESULT_OK,ISM);
                finish();
            }
        });
    ...
    private void initView() {
        ListView listview = (ListView) findViewById(R.id.smlistview); // 获取列表视图
        // 创建一个list集合
        listview.setAdapter(new SMAdapter(this));
    }
